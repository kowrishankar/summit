...
const styles = StyleSheet.create({
  ...
  switchBtn: { backgroundColor: '#1e293b', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
  ...
  categoryName: { flex: 1, fontSize: 14, color: '#e2e8f0' },
  categoryAmount: { fontSize: 14, fontWeight: '600', color: '#f8fafc' },
  categoryAmountIncome: { fontSize: 14, fontWeight: '600', color: '#22c55e' },
  categoryBarBg: { height: 6, backgroundColor: '#1e293b', borderRadius: 3, overflow: 'hidden' },
